            ...
            >
              ...
              >
                {/* Row actions idle at opacity-60 — dimmed but legible and
                    ...
                    the tab order throughout. Skipped on deleted rows, which
                    the row itself already dims to opacity-50: compounding the
                    two put Restore at 1.95:1, under the 3:1 minimum
                    (decision #53). */}
                <div
                  className={cn(
